# Getting help with `ExampleBiocWorkshop2023`

Thank you for using `ExampleBiocWorkshop2023`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/ExampleBiocWorkshop2023`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/ExampleBiocWorkshop2023),
...
[search issues and pull requests](https://github.com/lcolladotor/ExampleBiocWorkshop2023/issues)
